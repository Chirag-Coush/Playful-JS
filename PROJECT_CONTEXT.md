...
At this point the project has 83 chapters total.
...
- expand practical chapters after functions and array methods into objects, `this`, constructors/classes, async, DOM, fetch, and project-oriented examples;

const practicalLessons = [
  ...
  },
  {
    ...
    intro:
      "Counters track how many times something happened, scores track points, and positions track where something is on screen. Arithmetic reads the current number, creates a new result, then the variable points to that result.",
    code: ["let counter = 0;", "let score = 10;", "let x = 40;", "counter = counter + 1;", "score = score + 5;", "x = x + 20;"],
    legend: ["variable", "value", "wire"],
    nodes: {
      counter: { label: "counter", kind: "variable-wide", x: 16, y: 26 },
      score: { label: "score", kind: "variable-wide", x: 16, y: 54 },
      x: { label: "x", kind: "variable", x: 16, y: 82 },
    ...
    steps: [
      {
        ...
        description:
          "counter starts at 0, score starts at 10, and x starts at 40. These names tell you what each number is for.",
        line: 0,
        visible: ["counter", "zero", "score", "ten", "x", "forty"],
        wires: [
          { id: "counter-zero", from: "counter", to: "zero", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-ten", from: "score", to: "ten", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "x-forty", from: "x", to: "forty", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["counter", "zero", "score", "ten", "x", "forty"],
      },
      {
        title: "Evaluate the counter update",
        description:
          "counter + 1 reads the current counter value 0, adds 1, and creates the new value 1.",
        line: 3,
        visible: ["counter", "zero", "one", "score", "ten", "x", "forty"],
        wires: [
          { id: "counter-zero", from: "counter", to: "zero", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-ten", from: "score", to: "ten", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "x-forty", from: "x", to: "forty", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["zero", "one"],
      },
      {
        title: "Move the counter wire",
        description:
          "After the right side creates 1, assignment moves counter's wire from 0 to 1.",
        line: 3,
        visible: ["counter", "zero", "one", "score", "ten", "x", "forty"],
        wires: [
          { id: "counter-one", from: "counter", to: "one", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-ten", from: "score", to: "ten", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "x-forty", from: "x", to: "forty", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["counter", "one"],
      },
      {
        ...
        line: 4,
        visible: ["counter", "one", "score", "ten", "five", "fifteen", "x", "forty"],
        wires: [
          { id: "counter-one", from: "counter", to: "one", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-ten", from: "score", to: "ten", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "x-forty", from: "x", to: "forty", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
      ...
      },
      {
        ...
        line: 4,
        visible: ["counter", "one", "score", "ten", "fifteen", "x", "forty"],
        wires: [
          { id: "counter-one", from: "counter", to: "one", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
      ...
      },
      {
        ...
        description:
          "x + 20 reads the current x-position 40, adds 20, and creates the new position value 60.",
        line: 5,
        visible: ["counter", "one", "score", "fifteen", "x", "forty", "twenty", "sixty"],
        wires: [
          { id: "counter-one", from: "counter", to: "one", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
      ...
      },
      {
        ...
        description:
          "After the right side creates 60, x points to 60. This is how code moves things across a screen.",
        line: 5,
        visible: ["counter", "one", "score", "fifteen", "x", "forty", "sixty"],
        wires: [
          { id: "counter-one", from: "counter", to: "one", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-fifteen", from: "score", to: "fifteen", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "x-sixty", from: "x", to: "sixty", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["x", "sixty"],
      },
    ],

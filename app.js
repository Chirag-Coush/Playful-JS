const practicalLessons = [
  ...
  },
  {
    ...
    universeTitle: "Arithmetic updates counters, scores, and positions",
    intro:
      "Addition always does the same JavaScript work: read numbers, create a new number, then store it. In app code, the meaning changes because one number represents clicks, another represents points, and another represents a screen position.",
    code: ["let clickCount = 0;", "let score = 10;", "let playerX = 40;", "clickCount = clickCount + 1;", "score = score + 5;", "playerX = playerX + 20;"],
    legend: ["variable", "value", "wire"],
    nodes: {
      clickCount: { label: "clickCount", kind: "variable-wide", x: 16, y: 26 },
      score: { label: "score", kind: "variable-wide", x: 16, y: 54 },
      playerX: { label: "playerX", kind: "variable-wide", x: 16, y: 82 },
      zero: { label: "0", kind: "value", x: 46, y: 26 },
      one: { label: "1", kind: "value", x: 74, y: 26 },
      ten: { label: "10", kind: "value", x: 46, y: 54 },
      five: { label: "5", kind: "value", x: 62, y: 42 },
      fifteen: { label: "15", kind: "value", x: 74, y: 54 },
      forty: { label: "40", kind: "value", x: 46, y: 82 },
      twenty: { label: "20", kind: "value", x: 62, y: 70 },
      sixty: { label: "60", kind: "value", x: 74, y: 82 },
    },
    steps: [
      {
        title: "Start with useful numbers",
        description:
          "clickCount starts at 0, score starts at 10, and playerX starts at 40. The names tell you what each number represents.",
        line: 0,
        visible: ["clickCount", "zero", "score", "ten", "playerX", "forty"],
        wires: [
          { id: "clickCount-zero", from: "clickCount", to: "zero", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-ten", from: "score", to: "ten", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "playerX-forty", from: "playerX", to: "forty", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        notes: [
          { text: "clickCount means button clicks", x: 46, y: 12 },
          { text: "score means points", x: 46, y: 40 },
          { text: "playerX means horizontal position", x: 46, y: 68 },
        ],
        active: ["clickCount", "zero", "score", "ten", "playerX", "forty"],
      },
      {
        title: "Evaluate the click count update",
        description:
          "clickCount + 1 reads the current click count 0, adds 1, and creates the new value 1.",
        line: 3,
        visible: ["clickCount", "zero", "one", "score", "ten", "playerX", "forty"],
        wires: [
          { id: "clickCount-zero", from: "clickCount", to: "zero", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-ten", from: "score", to: "ten", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "playerX-forty", from: "playerX", to: "forty", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        notes: [{ text: "same + operator; this time it counts one more click", x: 61, y: 12 }],
        active: ["zero", "one"],
      },
      {
        title: "Move the click count wire",
        description:
          "After the right side creates 1, assignment moves clickCount's wire from 0 to 1.",
        line: 3,
        visible: ["clickCount", "zero", "one", "score", "ten", "playerX", "forty"],
        wires: [
          { id: "clickCount-one", from: "clickCount", to: "one", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-ten", from: "score", to: "ten", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "playerX-forty", from: "playerX", to: "forty", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["clickCount", "one"],
      },
      {
        title: "Evaluate the score update",
        description:
          "score + 5 reads the current score 10, adds 5, and creates the new score value 15.",
        line: 4,
        visible: ["clickCount", "one", "score", "ten", "five", "fifteen", "playerX", "forty"],
        wires: [
          { id: "clickCount-one", from: "clickCount", to: "one", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-ten", from: "score", to: "ten", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "playerX-forty", from: "playerX", to: "forty", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        notes: [{ text: "same + operator; this time it adds points", x: 61, y: 40 }],
        active: ["ten", "five", "fifteen"],
      },
      {
        title: "Move the score wire",
        description:
          "After the right side creates 15, assignment moves score's wire from 10 to 15.",
        line: 4,
        visible: ["clickCount", "one", "score", "ten", "fifteen", "playerX", "forty"],
        wires: [
          { id: "clickCount-one", from: "clickCount", to: "one", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-fifteen", from: "score", to: "fifteen", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "playerX-forty", from: "playerX", to: "forty", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["score", "fifteen"],
      },
      {
        title: "Evaluate the position update",
        description:
          "playerX + 20 reads the current x-position 40, adds 20, and creates the new position value 60.",
        line: 5,
        visible: ["clickCount", "one", "score", "fifteen", "playerX", "forty", "twenty", "sixty"],
        wires: [
          { id: "clickCount-one", from: "clickCount", to: "one", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-fifteen", from: "score", to: "fifteen", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "playerX-forty", from: "playerX", to: "forty", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        notes: [{ text: "same + operator; this time it means move right", x: 61, y: 68 }],
        active: ["forty", "twenty", "sixty"],
      },
      {
        title: "Move the position wire",
        description:
          "After the right side creates 60, playerX points to 60. This is how code moves things across a screen.",
        line: 5,
        visible: ["clickCount", "one", "score", "fifteen", "playerX", "forty", "sixty"],
        wires: [
          { id: "clickCount-one", from: "clickCount", to: "one", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "score-fifteen", from: "score", to: "fifteen", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "playerX-sixty", from: "playerX", to: "sixty", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["playerX", "sixty"],
      },
    ],
    quiz: {
      prompt: "What happens in score = score + 5?",
      options: ["score points to 15", "5 changes into 15", "score points to itself"],
      answer: "score points to 15",
      correct: "Correct. The right side creates 15, then score points to that new result.",
      wrong: "Not quite. The old score is read first, then the variable points to the new result value.",
    },
  },
  {
    ...
    intro:
      "User input usually reaches JavaScript as text. Forms, prompts, search boxes, and URL fields can look numeric to a person while still being string values in code.",
  ...
  },
  {
    ...
    intro:
      "Conversion means creating a new value in the type you actually need. It is common when numbers arrive from forms, URLs, APIs, or localStorage as strings.",
  ...
  },
  {
    ...
    number: "Practical 6",
    title: "If Statements",
    universeTitle: "if can set validation state",
    intro:
      "Real projects often use if statements to check form input and store a clear error value when something is missing.",
    code: ['let username = "";', "let error = null;", 'if (username === "") {', '  error = "Name required";', "}"],
    legend: ["variable", "value", "wire"],
    nodes: {
      username: { label: "username", kind: "variable-wide", x: 18, y: 28 },
      emptyString: { label: '""', kind: "string", x: 58, y: 28 },
      error: { label: "error", kind: "variable-wide", x: 18, y: 58 },
      nullValue: { label: "null", kind: "value", x: 58, y: 58 },
      condition: { label: "true", kind: "string", x: 58, y: 78 },
      required: { label: '"Name required"', kind: "string", x: 78, y: 58 },
    },
    steps: [
      {
        title: "Store the input",
        description: 'username points to an empty string. This is what an empty form field can look like in JavaScript.',
        line: 0,
        visible: ["username", "emptyString"],
        wires: [{ id: "username-emptyString", from: "username", to: "emptyString", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } }],
        active: ["username", "emptyString"],
      },
      {
        title: "Start with no error",
        description: "error points to null, which means there is no error message yet.",
        line: 1,
        visible: ["username", "emptyString", "error", "nullValue"],
        wires: [
          { id: "username-emptyString", from: "username", to: "emptyString", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "error-nullValue", from: "error", to: "nullValue", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["error", "nullValue"],
      },
      {
        title: "Check the field",
        description: 'username === "" compares the current username value with an empty string and creates true.',
        line: 2,
        visible: ["username", "emptyString", "error", "nullValue", "condition"],
        wires: [
          { id: "username-emptyString", from: "username", to: "emptyString", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "error-nullValue", from: "error", to: "nullValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["emptyString", "condition"],
      },
      {
        title: "Store the error",
        description: 'Because the condition is true, JavaScript runs the block. error moves from null to "Name required".',
        line: 3,
        visible: ["username", "emptyString", "error", "nullValue", "condition", "required"],
        wires: [
          { id: "username-emptyString", from: "username", to: "emptyString", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "error-required", from: "error", to: "required", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["error", "required"],
      },
    ],
    quiz: {
      prompt: "Why does error point to \"Name required\"?",
      options: ["the field is empty", "null changed itself", "if always runs"],
      answer: "the field is empty",
      correct: "Correct. The empty username made the condition true, so the validation block ran.",
      wrong: "Not quite. The block runs because username is an empty string.",
    },
  },
  {
  ...
  },
  {
    ...
    intro:
      'A ternary chooses one of two values in one expression. It is useful for labels, CSS classes, status text, and small UI choices: condition ? value when true : value when false.',
    ...
    steps: [
      ...
      {
        title: "Create label and test",
        description: "JavaScript creates the label variable, then evaluates the right side. count === 0 creates true.",
        line: 1,
        visible: ["count", "zero", "label", "condition"],
        wires: [{ id: "count-zero", from: "count", to: "zero", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } }],
        active: ["label", "condition"],
        notes: [{ text: "condition ? value if true : value if false", x: 54, y: 20 }],
      },
      {
        title: "Evaluate the true value",
        description: 'The ? starts the two choices. Because the condition is true, JavaScript evaluates the value before : and produces "Empty".',
        line: 1,
        visible: ["count", "zero", "condition", "label", "empty"],
        wires: [
          { id: "count-zero", from: "count", to: "zero", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["empty"],
        notes: [{ text: "The value after : is the false choice, so it is skipped here.", x: 54, y: 84 }],
      },
      {
        title: "Store the chosen value",
        description: 'The ternary expression produced "Empty", so label points to that string. ? and : are not returns; together they choose one expression value.',
        line: 1,
        visible: ["count", "zero", "condition", "label", "empty"],
        wires: [
          { id: "count-zero", from: "count", to: "zero", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
    ...
    quiz: {
      prompt: "In condition ? a : b, what does : introduce?",
      options: ["the false value", "another condition", "a return statement"],
      answer: "the false value",
      correct: "Correct. The value after : is used when the condition is false.",
      wrong: "Not quite. ? starts the choice, and : separates the value used when the condition is false.",
    },
  },
  {
    ...
    intro:
      "switch compares one value against several cases. It is useful for status labels, keyboard shortcuts, route names, and simple command handling.",
  ...
  },
  {
    ...
    intro:
      "Strict equality compares without surprise type conversion. Real projects use it for checks like selected IDs, feature flags, form values, and API status values.",
  ...
  },
  {
    ...
    number: "Practical 14",
    title: "For Loops",
    universeTitle: "for puts setup, check, and update in one header",
    intro:
      "A for loop is useful when code needs a built-in counter, such as adding totals, walking through arrays, animation frames, or repeated UI rows.",
  ...
  },
  {
    ...
    number: "Practical 15",
    title: "Arrays",
    universeTitle: "Arrays grow as list data changes",
    intro:
      "In everyday app code, arrays hold changing lists: cart items, todos, messages, users, products, and search results.",
    code: ["let cart = [];", 'cart.push("Book");', "let itemCount = cart.length;"],
    legend: ["variable", "object", "property", "value"],
    nodes: {
      cart: { label: "cart", kind: "variable-wide", x: 18, y: 46 },
      array: { label: "[ ]", kind: "object", x: 42, y: 46 },
      book: { label: '"Book"', kind: "string", x: 70, y: 38 },
      zero: { label: "0", kind: "value", x: 70, y: 62 },
      one: { label: "1", kind: "value", x: 70, y: 78 },
      itemCount: { label: "itemCount", kind: "variable-wide", x: 18, y: 82 },
    },
    steps: [
      {
        title: "Create an empty list",
        description: "cart points to an empty array object. It has no item indexes yet, and its length is 0.",
        line: 0,
        visible: ["cart", "array", "zero"],
        wires: [
          { id: "cart-array", from: "cart", to: "array", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "array-zero", from: "array", to: "zero", label: "length", tone: "cyan", fromAnchor: { side: "right", offset: 10 }, toAnchor: { side: "left" } },
        ],
        active: ["cart", "array", "zero"],
      },
      {
        title: "Push an item",
        description: 'push mutates the same array object. It adds index 0 pointing to "Book" and updates length to 1.',
        line: 1,
        visible: ["cart", "array", "book", "one"],
        wires: [
          { id: "cart-array", from: "cart", to: "array", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "array-book", from: "array", to: "book", label: "0", tone: "orange", fromAnchor: { side: "right", offset: -12 }, toAnchor: { side: "left" } },
          { id: "array-one", from: "array", to: "one", label: "length", tone: "cyan", fromAnchor: { side: "right", offset: 12 }, toAnchor: { side: "left" } },
        ],
        active: ["array", "book", "one"],
      },
      {
        title: "Read the list size",
        description: "cart.length follows the length property and returns 1, so itemCount points to the number 1.",
        line: 2,
        visible: ["cart", "array", "book", "one", "itemCount"],
        wires: [
          { id: "cart-array", from: "cart", to: "array", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "array-book", from: "array", to: "book", label: "0", tone: "slate", fromAnchor: { side: "right", offset: -12 }, toAnchor: { side: "left" } },
          { id: "array-one", from: "array", to: "one", label: "length", tone: "slate", fromAnchor: { side: "right", offset: 12 }, toAnchor: { side: "left" } },
          { id: "itemCount-one", from: "itemCount", to: "one", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left", offset: 12 } },
        ],
        active: ["itemCount", "one"],
      },
    ],
    quiz: {
      prompt: "What does cart.length read after one push?",
      options: ["1", '"Book"', "0"],
      answer: "1",
      correct: "Correct. The array has one item, so length returns 1.",
      wrong: "Not quite. push added one item, so the array length is 1.",
    },
  },
  {
  ...
  },
  {
    ...
    legend: ["variable", "object", "value", "wire"],
    nodes: {
      showReady: { label: "showReady", kind: "variable-wide", x: 16, y: 34 },
      callbackValue: { label: "=> fn", kind: "object", x: 44, y: 34 },
      setTimeout: { label: "setTimeout", kind: "variable-wide", x: 16, y: 62 },
      timerApi: { label: "fn", kind: "object", x: 44, y: 62 },
      delay: { label: "1000", kind: "value", x: 44, y: 82 },
      browserTimer: { label: "timer", kind: "object-large", x: 72, y: 62 },
      ready: { label: '"Ready"', kind: "string", x: 72, y: 34 },
    },
    steps: [
      {
        title: "Create an arrow function",
        description: "() => { ... } creates a function value. showReady points to it, but the body has not run.",
        line: 0,
        visible: ["showReady", "callbackValue"],
        wires: [{ id: "showReady-callbackValue", from: "showReady", to: "callbackValue", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } }],
        active: ["showReady", "callbackValue"],
      },
      {
        title: "Evaluate the timer call",
        description: "setTimeout(showReady, 1000) reads the timer function, reads the callback function, and reads the delay value.",
        line: 3,
        visible: ["showReady", "callbackValue", "setTimeout", "timerApi", "delay"],
        wires: [
          { id: "showReady-callbackValue", from: "showReady", to: "callbackValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "setTimeout-timerApi", from: "setTimeout", to: "timerApi", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["setTimeout", "timerApi", "callbackValue", "delay"],
      },
      {
        title: "Browser stores it for later",
        description: "The browser timer keeps the callback function and delay. Passing showReady still does not run console.log yet.",
        line: 3,
        visible: ["showReady", "callbackValue", "setTimeout", "timerApi", "delay", "browserTimer"],
        wires: [
          { id: "showReady-callbackValue", from: "showReady", to: "callbackValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "setTimeout-timerApi", from: "setTimeout", to: "timerApi", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "timer-callbackValue", from: "browserTimer", to: "callbackValue", label: "stores", tone: "orange", fromAnchor: { side: "left" }, toAnchor: { side: "right" } },
          { id: "timer-delay", from: "browserTimer", to: "delay", label: "delay", tone: "cyan", fromAnchor: { side: "left", offset: 14 }, toAnchor: { side: "right" } },
        ],
        active: ["browserTimer", "callbackValue", "delay"],
      },
      {
        title: "Later, the callback runs",
        description: 'After about 1000 ms, the browser calls the stored function. That is when console.log receives "Ready".',
        line: 1,
        visible: ["callbackValue", "browserTimer", "ready"],
        wires: [
          { id: "timer-callbackValue", from: "browserTimer", to: "callbackValue", label: "calls", tone: "orange", fromAnchor: { side: "left" }, toAnchor: { side: "right" } },
    ...
    quiz: {
      prompt: "When does showReady run?",
      options: ["when timer calls it", "when it is created", "when it is passed"],
      answer: "when timer calls it",
      correct: "Correct. Passing a callback stores the function value; the timer calls it later.",
      wrong: "Not quite. The callback runs later when the timer API calls it.",
    },
  },
  {
  ...
  },
  {
    ...
    intro:
      "reduce combines an array into one value. It receives two arguments: first a callback, then an initial value. The callback receives its own parameters: sum is the result so far and price is the current item. Shopping cart apps use this to calculate totals.",
    code: ["let cart = [5, 10, 15];", "let total = cart.reduce(", "  (sum, price) => sum + price, // first argument", "  0                              // second argument", ");"],
    legend: ["variable", "object", "value", "wire"],
    nodes: {
      cart: { label: "cart", kind: "variable-wide", x: 14, y: 22 },
      array: { label: "[ ]", kind: "object", x: 38, y: 22 },
      five: { label: "5", kind: "value", x: 70, y: 12 },
      ten: { label: "10", kind: "value", x: 70, y: 26 },
      fifteen: { label: "15", kind: "value", x: 70, y: 40 },
      callback: { label: "fn", kind: "object", x: 38, y: 52 },
      sum: { label: "sum", kind: "variable-wide", x: 14, y: 70 },
      price: { label: "price", kind: "variable-wide", x: 14, y: 86 },
      zero: { label: "0", kind: "value", x: 48, y: 70 },
      total: { label: "total", kind: "variable-wide", x: 62, y: 78 },
      thirty: { label: "30", kind: "value", x: 88, y: 78 },
    },
    steps: [
      {
      ...
      {
        title: "Evaluate the first reduce argument",
        description: "(sum, price) => sum + price creates the callback function value. The callback has not run yet.",
        line: 2,
        visible: ["cart", "array", "five", "ten", "fifteen", "callback"],
        wires: [
          { id: "cart-array", from: "cart", to: "array", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "array-five", from: "array", to: "five", label: "0", tone: "slate", fromAnchor: { side: "right", offset: -16 }, toAnchor: { side: "left" } },
          { id: "array-ten", from: "array", to: "ten", label: "1", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
      ...
      {
        title: "Evaluate the second reduce argument",
        description: "0 is the initial value. reduce uses it as sum when it makes the first callback call.",
        line: 3,
        visible: ["cart", "array", "five", "ten", "fifteen", "callback", "sum", "zero"],
        wires: [
          { id: "cart-array", from: "cart", to: "array", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "array-five", from: "array", to: "five", label: "0", tone: "slate", fromAnchor: { side: "right", offset: -16 }, toAnchor: { side: "left" } },
          { id: "array-ten", from: "array", to: "ten", label: "1", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
      ...
      },
      {
        ...
        active: ["sum", "price", "five", "ten", "fifteen"],
      },
      {
        ...
        active: ["sum", "price", "fifteen", "thirty"],
      },
      {
        title: "Store the reduced result",
        description: "reduce returns the final 30. Only now does total point to that returned value.",
        line: 1,
    ...
    quiz: {
      prompt: "What are the two arguments passed directly to reduce?",
      options: ["callback and 0", "sum and price", "cart and total"],
      answer: "callback and 0",
      correct: "Correct. The callback is reduce's first argument, and 0 is its second argument.",
      wrong: "Not quite. sum and price are parameters created later when reduce calls the callback.",
    },
  },
  {
    ...
    steps: [
      {
        title: "Create a function declaration",
        description: "function double(...) is a function declaration. It creates a function value and binds the name double to it.",
        line: 0,
        visible: ["double", "doubleFn"],
        wires: [{ id: "double-doubleFn", from: "double", to: "doubleFn", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } }],
        active: ["double", "doubleFn"],
      },
      {
        title: "Store a function expression",
        description: "const add = function(...) uses a function expression. The expression creates a function value, then add points to it.",
        line: 1,
        visible: ["double", "doubleFn", "add", "addFn"],
        wires: [
      ...
      },
      {
        ...
        description: "const multiply = (a, b) => a * b uses arrow syntax. It also creates a function value, and multiply points to it.",
        line: 2,
        visible: ["double", "doubleFn", "add", "addFn", "multiply", "multiplyFn"],
        wires: [
          { id: "double-doubleFn", from: "double", to: "doubleFn", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
    ...
    quiz: {
      prompt: "What do declarations, expressions, and arrows create?",
      ...
      wrong: "Not quite. All three examples create function values that names can point to.",
    },
  },
  {
  ...
  },
  {
    ...
    intro:
      "A getter lets code read something like a property while JavaScript runs a function behind the scenes. It is useful for formatted labels, computed totals, and class APIs.",
...
const conceptLessons = [
  ...
  },
  {
    ...
    intro:
      "An object is a value that contains named property wires. Real apps use objects for users, products, settings, API records, and anything with several related facts.",
    code: [
      "let sherlock = {",
      '  surname: "Holmes",',
      '  address: { city: "London" }',
  ...
  },
  {
    ...
    intro:
      "Mutation and reassignment can both use =, but they change different wires. Mutation changes data inside an existing object, while reassignment makes a variable point to a different value. This matters when two parts of an app share the same user, settings, or form object.",
    code: [
      'let user = { name: "Ada" };',
      "let admin = user;",
      'admin.name = "Grace"; // mutation',
      'admin = { name: "Lin" }; // reassignment',
    ],
    legend: ["variable", "object", "property", "value"],
    nodes: {
      user: { label: "user", kind: "variable-wide", x: 16, y: 31 },
      admin: { label: "admin", kind: "variable-wide", x: 16, y: 70 },
      sharedPerson: { label: "{ }", kind: "object", x: 45, y: 38 },
      newPerson: { label: "{ }", kind: "object", x: 45, y: 72 },
      ada: { label: '"Ada"', kind: "string", x: 76, y: 18 },
      grace: { label: '"Grace"', kind: "string", x: 76, y: 40 },
      lin: { label: '"Lin"', kind: "string", x: 76, y: 72 },
    },
    steps: [
      {
        title: "Create user and its object",
        description:
          'JavaScript creates user, evaluates the object literal, then points user to that object. Its name property points to "Ada".',
        line: 0,
        visible: ["user", "sharedPerson", "ada"],
        wires: [
          {
            id: "user-shared",
            from: "user",
        ...
        active: ["user", "sharedPerson", "ada"],
      },
      {
        title: "Create the admin variable",
        description:
          "For let admin = user, JavaScript first creates the admin variable. It does not point anywhere yet.",
        line: 1,
        visible: ["user", "admin", "sharedPerson", "ada"],
        wires: [
          {
            id: "user-shared",
            from: "user",
      ...
      },
      {
        title: "Evaluate user",
        description:
          "JavaScript evaluates the right side. user produces the existing object value; it does not create a copy.",
        line: 1,
        visible: ["user", "admin", "sharedPerson", "ada"],
        wires: [
          {
        ...
        active: ["user", "sharedPerson"],
      },
      {
        title: "Point admin to the object",
        description:
          "The assignment finishes by pointing admin to that result. user and admin now share one object.",
        line: 1,
        visible: ["user", "admin", "sharedPerson", "ada"],
        wires: [
          {
        ...
        active: ["admin", "sharedPerson"],
      },
      {
        title: "Identify the property wire",
        description:
          "In admin.name = ..., the left side is the name property inside the shared object. The admin variable wire is not the target.",
        line: 2,
        visible: ["user", "admin", "sharedPerson", "ada"],
        wires: [
          {
        ...
        active: ["sharedPerson", "ada"],
      },
      {
        title: "Evaluate the new name",
        description:
          'JavaScript evaluates the right side and gets the string value "Grace". The property still points to "Ada" for this moment.',
        line: 2,
        visible: ["user", "admin", "sharedPerson", "ada", "grace"],
        wires: [
          {
            id: "user-shared",
            from: "user",
      ...
      },
      {
        ...
        description:
          'The name property wire moves to "Grace". Both user.name and admin.name now read "Grace". Nothing in this code points to "Ada" anymore.',
        line: 2,
        visible: ["user", "admin", "sharedPerson", "grace"],
        wires: [
          {
            id: "user-shared",
            from: "user",
        ...
        active: ["sharedPerson", "grace"],
        notes: [
          {
            text: "Mutation moved a property wire inside the shared object.",
            x: 49,
            y: 14,
          },
        ],
      ...
      {
        title: "Identify the variable wire",
        description:
          "In admin = ..., the left side is now the admin variable itself. The shared object's name property is not the target.",
        line: 3,
        visible: ["user", "admin", "sharedPerson", "grace"],
        wires: [
          {
      ...
      {
        title: "Evaluate a new object",
        description:
          'The right side creates a new object whose name property points to "Lin". admin still points to the shared object until assignment finishes.',
        line: 3,
        visible: ["user", "admin", "sharedPerson", "newPerson", "grace", "lin"],
        wires: [
          {
            id: "user-shared",
            from: "user",
        ...
        active: ["newPerson", "lin"],
      },
      {
        title: "Reassign admin",
        description:
          'The admin variable wire moves to the new object. user still points to the original object, so user.name remains "Grace" while admin.name is "Lin".',
        line: 3,
        visible: ["user", "admin", "sharedPerson", "newPerson", "grace", "lin"],
        wires: [
          {
        ...
        active: ["admin", "newPerson"],
        notes: [
          {
            text: "Reassignment moved a variable wire; the original object did not change.",
            x: 49,
            y: 57,
          },
        ],
    ...
    quiz: {
      prompt: 'After admin = { name: "Lin" }, what is user.name?',
      options: ['"Grace"', '"Lin"', "undefined"],
      answer: '"Grace"',
      correct:
        'Correct. Reassigning admin does not move user or change the original object.',
      wrong:
        'Not quite. Only the admin variable was reassigned. user still points to the object whose name is "Grace".',
    },
  },
  {
    id: "object-identity",
    ...
    intro:
      "Objects are compared by identity, not by matching contents. This matters when checking selected items, cached records, React dependencies, and whether two variables point to the same object.",
  ...
  },
  {
    ...
    intro:
      "Arrays are object-like values for ordered lists. Their indexes behave like property names, which matters when code reads cart items, rows, messages, or search results.",
  ...
  },
  {
    ...
    intro:
      "Scope decides where a variable can be used. Blocks keep helper values local, which is useful in validation, loops, and temporary calculations that should not leak into the rest of the code.",
  ...
  },
  {
    ...
    intro:
      "An if statement lets JavaScript choose whether to run a block. You see it in form validation, access checks, loading states, and showing different UI messages.",
  ...
  },
  {
    ...
    intro:
      "A while loop repeats while a condition stays true. It is useful for retrying work, stepping through unknown input, or running until a limit is reached.",
  ...
  },
  {
    ...
    intro:
      "JavaScript often checks whether a value behaves like true or false. This shows up when choosing default text, hiding empty sections, or checking whether input exists.",
  ...
  },
  {
    ...
    intro:
      "Destructuring is a shortcut for reading properties from an object into new variables. It is common with function options, React props, API records, and configuration objects.",
  ...
  },
  {
    ...
    intro:
      "Copying a method into another variable copies only the function value. This matters in event handlers, callbacks, and class code because the function may no longer know which object this should be.",
    code: [
      '"use strict";',
      "let user = {",
      '  name: "Ada",',
  ...
  },
  {
    ...
    intro:
      "map calls a callback for each item and collects each returned value into a new array. It is common when turning API data into labels, cards, list rows, or calculated prices.",
  ...
  },
  {
    ...
    universeTitle: "JavaScript sometimes converts values for you",
    intro:
      "Implicit coercion is the trap after explicit conversion: some operators convert values automatically. In form, URL, and API code, that can turn number work into text work if you do not convert first.",
    code: ['let input = "42";', "let surprise = input + 8;", "let total = Number(input) + 8;"],
    legend: ["variable", "wire", "value"],
    nodes: {
      input: { label: "input", kind: "variable-wide", x: 16, y: 34 },
      string42: { label: '"42"', kind: "string", x: 48, y: 34 },
      surprise: { label: "surprise", kind: "variable-wide", x: 16, y: 58 },
      eight: { label: "8", kind: "value", x: 48, y: 58 },
      string428: { label: '"428"', kind: "string", x: 72, y: 58 },
      total: { label: "total", kind: "variable-wide", x: 16, y: 84 },
      number42: { label: "42", kind: "value", x: 48, y: 84 },
      fifty: { label: "50", kind: "value", x: 72, y: 84 },
    },
    steps: [
      {
      ...
      {
        title: "Evaluate input + 8",
        description:
          'Because input points to a string, the + operator creates text: "42" joined with "8" becomes "428".',
        line: 1,
        visible: ["input", "string42", "eight", "string428"],
        wires: [
          { id: "input-string42", from: "input", to: "string42", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["string42", "eight", "string428"],
      },
      {
        title: "Store the surprise",
        description:
          'After the right side is evaluated, surprise points to the string "428".',
        line: 1,
        visible: ["input", "string42", "surprise", "eight", "string428"],
        wires: [
          { id: "input-string42", from: "input", to: "string42", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "surprise-string428", from: "surprise", to: "string428", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["surprise", "string428"],
      },
      {
        title: "Convert before adding",
        description:
          'Number(input) creates the number 42 first, so the next + can do numeric addition.',
        line: 2,
        visible: ["input", "string42", "surprise", "string428", "number42"],
        wires: [
          { id: "input-string42", from: "input", to: "string42", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "surprise-string428", from: "surprise", to: "string428", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["string42", "number42"],
      },
      {
        title: "Store the numeric result",
        description:
          "42 + 8 creates 50, so total points to the number 50.",
        line: 2,
        visible: ["input", "string42", "surprise", "string428", "total", "number42", "fifty"],
        wires: [
          { id: "input-string42", from: "input", to: "string42", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "surprise-string428", from: "surprise", to: "string428", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
    ...
    quiz: {
      prompt: 'What does input + 8 create when input is "42"?',
      options: ['"428"', "50", "8"],
      answer: '"428"',
      correct: 'Correct. With a string on one side, + creates text instead of doing number addition.',
      wrong: 'Not quite. The string "42" makes + join text, so the result is "428".',
    },
  },
  {
    id: "nan",

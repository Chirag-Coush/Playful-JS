const practicalLessons = [
  ...
  },
  {
    ...
    intro:
      "The Math object gives you helpers for rounding, limits, and random values, useful for games and UI behavior.",
    code: ["let random = Math.random();", "let scaled = random * 6;", "let rounded = Math.floor(scaled);", "let dice = rounded + 1;"],
    legend: ["variable", "object", "value", "wire"],
    nodes: {
      math: { label: "Math", kind: "variable-wide", x: 18, y: 30 },
      randomValue: { label: "0.7", kind: "value", x: 60, y: 28 },
      random: { label: "random", kind: "variable-wide", x: 18, y: 50 },
      scaled: { label: "scaled", kind: "variable-wide", x: 18, y: 70 },
      scaledValue: { label: "4.3", kind: "value", x: 60, y: 62 },
      rounded: { label: "rounded", kind: "variable-wide", x: 18, y: 80 },
      four: { label: "4", kind: "value", x: 60, y: 80 },
      dice: { label: "dice", kind: "variable-wide", x: 58, y: 92 },
      five: { label: "5", kind: "value", x: 80, y: 92 },
    },
    steps: [
      {
      ...
      {
        title: "Round down",
        description: "Math.floor(4.3) creates the number 4. This gives us a whole number from 0 to 5.",
        line: 2,
        visible: ["math", "random", "randomValue", "scaled", "scaledValue", "rounded", "four"],
        wires: [
          { id: "random-randomValue", from: "random", to: "randomValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "scaled-scaledValue", from: "scaled", to: "scaledValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "rounded-four", from: "rounded", to: "four", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["rounded", "four"],
      },
      {
        title: "Shift to a dice range",
        description: "rounded + 1 creates 5. Adding 1 changes the range from 0-5 to 1-6.",
        line: 3,
        visible: ["math", "random", "randomValue", "scaled", "scaledValue", "rounded", "four", "dice", "five"],
        wires: [
          { id: "random-randomValue", from: "random", to: "randomValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "scaled-scaledValue", from: "scaled", to: "scaledValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "rounded-four", from: "rounded", to: "four", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
    ...
    quiz: {
      prompt: "Why add 1 after Math.floor(scaled)?",
      options: ["to shift 0-5 into 1-6", "to make a string", "to stop randomness"],
      answer: "to shift 0-5 into 1-6",
      correct: "Correct. floor gives 0 through 5, then + 1 gives 1 through 6.",
      wrong: "Not quite. The + 1 shifts the dice range upward.",
    },
  },
  {
  ...
  },
  {
    ...
    code: ["let loggedIn = true;", "let isAdmin = false;", "let canEdit = loggedIn && isAdmin;"],
    legend: ["variable", "value", "wire"],
    nodes: {
      loggedIn: { label: "loggedIn", kind: "variable-wide", x: 20, y: 30 },
      trueValue: { label: "true", kind: "string", x: 64, y: 30 },
      isAdmin: { label: "isAdmin", kind: "variable-wide", x: 20, y: 54 },
      falseValue: { label: "false", kind: "string", x: 64, y: 54 },
      canEdit: { label: "canEdit", kind: "variable-wide", x: 20, y: 80 },
      result: { label: "false", kind: "string", x: 64, y: 80 },
    },
    steps: [
      {
      ...
      },
      {
        ...
        line: 2,
        visible: ["loggedIn", "trueValue", "isAdmin", "falseValue", "result"],
        wires: [
          { id: "loggedIn-trueValue", from: "loggedIn", to: "trueValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "isAdmin-falseValue", from: "isAdmin", to: "falseValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["trueValue", "falseValue", "result"],
      },
      {
        title: "Store canEdit",
        description: "After the expression is evaluated, canEdit points to the boolean result false.",
        line: 2,
        visible: ["loggedIn", "trueValue", "isAdmin", "falseValue", "canEdit", "result"],
        wires: [
          { id: "loggedIn-trueValue", from: "loggedIn", to: "trueValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "isAdmin-falseValue", from: "isAdmin", to: "falseValue", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
          { id: "canEdit-result", from: "canEdit", to: "result", tone: "orange", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
        ],
        active: ["canEdit", "result"],
      },
    ],
    quiz: {
      prompt: "What does true && false produce?",
      options: ["true", "false", "admin"],
      answer: "false",
      correct: "Correct. && needs both sides to be true.",
      wrong: "Not quite. With &&, one false side makes the whole expression false.",
    },
  },
  {
    id: "ternary-operator",
  ...
  },
  {
    ...
    intro:
      "Slicing is useful for initials, previews, file extensions, short IDs, and formatting UI text.",
    code: ['let filename = "photo.jpg";', "let extension = filename.slice(6);", "let preview = filename.slice(0, 5);"],
    legend: ["variable", "value", "wire"],
    nodes: {
      filename: { label: "filename", kind: "variable-wide", x: 20, y: 32 },
      photo: { label: '"photo.jpg"', kind: "string", x: 64, y: 32 },
      extension: { label: "extension", kind: "variable-wide", x: 20, y: 60 },
      jpg: { label: '"jpg"', kind: "string", x: 64, y: 60 },
      preview: { label: "preview", kind: "variable-wide", x: 20, y: 84 },
      short: { label: '"photo"', kind: "string", x: 64, y: 84 },
    },
    steps: [
      {
        title: "Store the full string",
        description: 'filename points to the string "photo.jpg". String positions start at index 0.',
        line: 0,
      ...
      {
        title: "Slice from an index",
        description: "slice(6) copies from index 6 to the end, creating the new string \"jpg\".",
        line: 1,
        visible: ["filename", "photo", "extension", "jpg"],
        wires: [
      ...
      {
        title: "Slice a range",
        description: "slice(0, 5) copies from index 0 up to, but not including, index 5.",
        line: 2,
        visible: ["filename", "photo", "extension", "jpg", "preview", "short"],
        wires: [
          { id: "filename-photo", from: "filename", to: "photo", tone: "slate", fromAnchor: { side: "right" }, toAnchor: { side: "left" } },
    ...
    quiz: {
      prompt: "What does filename.slice(6) produce?",
      options: ['"jpg"', '"photo"', '"photo.jpg"'],
      answer: '"jpg"',
      correct: "Correct. It copies from index 6 through the end.",
      wrong: "Not quite. slice(6) starts at the j in photo.jpg.",
    },
  },
  {
